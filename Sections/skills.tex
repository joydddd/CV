...
\section{SKILLS}
    ...
    \resumeItemListStart
        % LANGUAGES
        \eduItem{\textbf{Programming Languages}: C/C++, CUDA, HIP, SIMD, (system) verilog, bash, Makefile}
        % TOOLS
        \eduItem{\textbf{Technologies/Frameworks}:}
            \begin{itemize}
            ...
            \end{itemize}
        % TECHNOLOGIES
        \eduItem{\textbf{Architectures}: AMD CDNA2 Instinct GPU, NVIDIA Hopper GPU, Intel Xeon Phi, Out-of-order CPU}
